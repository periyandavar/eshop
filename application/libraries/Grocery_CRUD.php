...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function _print_webpage($data)
	{
		...
		$string_to_print.="<center><br><br><h3><b>AYYYA NADAR JANAKI AMMAL COLLEGE, SIVAKASI </b></h3><h3><b>DEPARTMENT OF COMPUTER SCIENCE </b></h3><h3>HACK-STARZ 2k20 </h3></center>";
if(isset($_SESSION['CustomTittle']) && $_SESSION['CustomTittle']<>'') 
	$string_to_print .= $_SESSION['CustomTittle'];
